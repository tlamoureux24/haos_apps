...
<section class="metrics operational-metrics"><article class="metric"><strong id="metric-connectors">–</strong><span>Connecteurs prêts</span></article><article class="metric"><strong id="metric-tasks">–</strong><span>Tâches prêtes</span></article><article class="metric"><strong id="metric-events">–</strong><span>Événements reçus sur 24 h</span></article><article class="metric amber"><strong id="metric-failures">–</strong><span>Échecs sur 24 h</span></article></section>
...
routes = [
    Route(
        path,
        route_handlers[path],
        methods=["POST"] if path in {"/admin/api/v1/connectors", "/admin/api/v1/connectors/check", "/admin/api/v1/connectors/delete", "/admin/api/v1/connectors/enabled", "/admin/api/v1/connectors/archived", "/admin/api/v1/tasks", "/admin/api/v1/tasks/delete", "/admin/api/v1/tasks/enabled", "/admin/api/v1/tasks/archived", "/admin/api/v1/tasks/run", "/admin/api/v1/schedules", "/admin/api/v1/schedules/update", "/admin/api/v1/schedules/enabled", "/admin/api/v1/schedules/delete", "/admin/api/v1/event-mappings", "/admin/api/v1/event-mappings/update", "/admin/api/v1/event-mappings/enabled", "/admin/api/v1/event-mappings/delete", "/admin/api/v1/identities", "/admin/api/v1/identities/revoke", "/admin/api/v1/jobs/cancel", "/admin/api/v1/jobs/requeue", "/admin/api/v1/retention/update", "/admin/api/v1/retention/run", "/api/v1/events"} else ["GET"],
    )
