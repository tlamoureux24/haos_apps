...
<section id="overview" class="view active"><section class="hero"><div><h1>Vue d’ensemble</h1><p>Consultez l’état opérationnel de la passerelle.</p></div><div class="health"><i></i><a href="{safe_prefix}/health/ready">Service opérationnel</a></div></section>
...
routes = [
    Route(
        path,
        route_handlers[path],
        methods=["POST"] if path in {"/admin/api/v1/connectors", "/admin/api/v1/connectors/check", "/admin/api/v1/connectors/delete", "/admin/api/v1/connectors/enabled", "/admin/api/v1/connectors/archived", "/admin/api/v1/tasks", "/admin/api/v1/tasks/delete", "/admin/api/v1/tasks/enabled", "/admin/api/v1/tasks/archived", "/admin/api/v1/tasks/run", "/admin/api/v1/schedules", "/admin/api/v1/schedules/update", "/admin/api/v1/schedules/enabled", "/admin/api/v1/schedules/delete", "/admin/api/v1/event-mappings", "/admin/api/v1/event-mappings/update", "/admin/api/v1/event-mappings/enabled", "/admin/api/v1/event-mappings/incidents/retry", "/admin/api/v1/event-mappings/delete", "/admin/api/v1/identities", "/admin/api/v1/identities/revoke", "/admin/api/v1/jobs/cancel", "/admin/api/v1/jobs/requeue", "/admin/api/v1/retention/update", "/admin/api/v1/retention/run", "/api/v1/events"} else ["GET"],
    )
