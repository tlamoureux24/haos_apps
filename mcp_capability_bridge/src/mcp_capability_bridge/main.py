...
from mcp_capability_bridge.contracts import AdapterCallError, AdapterRegistry, InvocationContext
...
def create_apps(state: RuntimeState) -> tuple[Starlette, Starlette]:
    ...
    async def web_targets(request:Request)->JSONResponse:
        ...
        try:
            ...
            configuration={"base_url":str(data.get("base_url","")),"resolved_addresses":list(addresses),"navigation_origins":[base],"authentication_origins":[base] if mode=="form" else [],"resource_origins":[base],"websocket_origins":[],"verify_tls":bool(data.get("verify_tls",True)),"certificate_sha256":str(data.get("certificate_sha256","")),"inactivity_seconds":int(data.get("inactivity_seconds",300)),"absolute_seconds":int(data.get("absolute_seconds",1800)),"authentication":authentication}
    ...
    async def web_test(request:Request)->JSONResponse:
        ...
        except AdapterCallError as exc:return JSONResponse({"error":{"code":exc.code}},status_code=422)
...
<section id="overview" class="view active"><div class="pagehead"><div><h1 data-i18n="overviewTitle"></h1><p data-i18n="overviewIntro"></p></div><span id="service-state" class="service-state state" data-i18n="serviceOperational"></span></div><h2 data-i18n="configurationSummary"></h2><section class="metrics"><article class="metric"><strong id="namespace-count">0</strong><span data-i18n="activeClients"></span></article><article class="metric"><strong id="target-count">0</strong><span data-i18n="activeTargets"></span></article><article class="metric"><strong id="publication-count">0</strong><span data-i18n="publishedCapabilities"></span></article><article class="metric"><strong id="adapter-count">0</strong><span data-i18n="adapters"></span></article></section><h2 data-i18n="runtimeSummary"></h2><section class="metrics"><article class="metric"><strong id="operation-count">0</strong><span data-i18n="activeOperations"></span></article><article class="metric"><strong id="busy-client-count">0</strong><span data-i18n="busyClients"></span></article><article class="metric"><strong id="busy-target-count">0</strong><span data-i18n="busyTargets"></span></article><article class="metric"><strong id="session-count">0</strong><span data-i18n="activeWebSessions"></span></article></section><article class="card notice"><h2 data-i18n="coreTitle"></h2><p data-i18n="coreText"></p></article></section>
