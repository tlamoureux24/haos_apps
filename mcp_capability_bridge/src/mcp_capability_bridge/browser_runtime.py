...
class BrowserRuntime:
    ...
    def _probe_sync(self,configuration,policy):
        ...
        try:
            ...
            driver=webdriver.Chrome(service=service,options=options);driver.set_page_load_timeout(20)
            if configuration.get("certificate_sha256"):driver.execute_cdp_cmd("Network.enable",{})
