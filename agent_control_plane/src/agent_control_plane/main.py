...
async def admin_transport(_: Request) -> JSONResponse:
    return JSONResponse({"events": {"transport": settings.events_transport, "internal_port": 8098, "path": "/api/v1/events"}, "mcp": {"transport": settings.mcp_transport, "internal_port": 8100, "path": "/mcp"}, "certificate": _certificate_payload()})
