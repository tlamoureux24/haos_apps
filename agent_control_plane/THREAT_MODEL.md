...
| Operator network → port 8098 | Internet exposure of Bearer endpoint or cleartext interception | Port unpublished by default; direct use documented for trusted LAN/VPN only; Agent Control Plane is not a public TLS terminator | **Documented** — `config.yaml`, bilingual README, `MCP_COMPATIBILITY.md` |
